...
export type ExchangeDataUpdate = Message<"session_exchange.ExchangeDataUpdate"> & {
  ...
  /**
   * Which book this update belongs to
   *
   * @generated from field: string book_id = 2;
   */
  bookId: string;
  ...
  /**
   * Sequential number for this book's updates
   *
...
export type SessionMetadata = Message<"session_exchange.SessionMetadata"> & {
  /**
   * Number of active connections for this book
   *
...
export type HeartbeatResponse = Message<"session_exchange.HeartbeatResponse"> & {
  ...
  /**
   * Connection status for this book
   *
...
export type SessionServiceStats = Message<"session_exchange.SessionServiceStats"> & {
  /**
   * Total number of books with active sessions
   *
   * @generated from field: int32 total_active_books = 1;
   */
  ...
  /**
   * Per-book session statistics
   *
   * @generated from field: map<string, session_exchange.BookSessionStats> book_stats = 3;
   */
  bookStats: { [key: string]: BookSessionStats };

  /**
   * Total updates sent across all books
   *
 ...
 *
 * @generated from message session_exchange.BookSessionStats
 */
export type BookSessionStats = Message<"session_exchange.BookSessionStats"> & {
  /**
  ...
  /**
   * Total updates sent to this book
   *
...
/**
 * Describes the message session_exchange.BookSessionStats.
 * Use `create(BookSessionStatsSchema)` to create a new message.
 */
export const BookSessionStatsSchema: GenMessage<BookSessionStats> = /*@__PURE__*/
...
export type SessionStatusResponse = Message<"session_exchange.SessionStatusResponse"> & {
  ...
  /**
   * Number of connections for this book
   *
