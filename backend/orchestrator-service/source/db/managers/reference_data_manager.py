...
class ReferenceDataManager(BaseManager):
    ...
    async def initialize_tables(self):
        ...
        await self.create_schema_if_not_exists('reference_data')
        ...
        # Create indexes
        await self.execute("CREATE INDEX IF NOT EXISTS idx_securities_sector ON reference_data.securities(sector)")
        await self.execute("CREATE INDEX IF NOT EXISTS idx_securities_exchange ON reference_data.securities(exchange)")
        await self.execute("CREATE INDEX IF NOT EXISTS idx_corporate_actions_symbol ON reference_data.corporate_actions(symbol, ex_date)")
