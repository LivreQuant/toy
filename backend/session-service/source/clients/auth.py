...
"""Authentication service client with standardized patterns."""
import logging
import time
import aiohttp
import asyncio
...
from source.utils.metrics import track_external_request, track_circuit_breaker_failure
...
class AuthClient(BaseClient):
    ...
    def __init__(self):
        ...
        super().__init__(service_name="auth_service")
    ...
    async def validate_token(self, token: str) -> Dict[str, Any]:
        ...
        with optional_trace_span(self.tracer, "validate_token") as span:
            ...
            try:
                ...
                return await self.execute_with_cb(self._validate_token_request, token)
    ...
    async def _validate_token_request(self, token: str) -> Dict[str, Any]:
        ...
        with optional_trace_span(self.tracer, "validate_token_request") as span:
            ...
            logger.debug(f"Validating token with auth service: {self.base_url}/api/auth/validate")
            try:
