...
# Assuming track_rest_request is defined here and handles Prometheus logic
...
# You could add other middleware functions here as needed, e.g., for request logging,
# specific authentication checks, etc.