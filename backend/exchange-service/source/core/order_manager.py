...
class OrderManager:
    ...
    def __init__(self, portfolio_manager, market_data_generator):
        ...
        Args:
            ...
            market_data_generator: Market data generator instance
        """
    ...
    def create_random_order(self, session_id: str) -> Optional[Dict[str, Any]]:
        ...
        metrics.increment_counter("random_order_created")
    ...
    def submit_order(self, session_id: str, symbol: str, side: str,
        ...
        if request_id:
            ...
            if request_key in self.request_ids:
                ...
                if existing_order:
                    ...
                    metrics.increment_counter("duplicate_order_detected")
                    return {
                        'success': True,
        ...
        if not symbol or quantity <= 0:
            metrics.increment_counter("order_validation_failed")
            return {
                'success': False,
        ...
        if result:
            metrics.increment_counter("order_submitted_success")
            return {
                'success': True,
                'order_id': order.order_id
            }
        else:
            metrics.increment_counter("order_submitted_failed")
            return {
                'success': False,
    ...
    def cancel_order(self, session_id: str, order_id: str) -> Dict[str, Any]:
        ...
        metrics.increment_counter("order_canceled")
        return {
            'success': True
        }
