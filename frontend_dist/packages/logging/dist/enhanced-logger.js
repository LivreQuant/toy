...
export { LogLevel } from '@trading-app/types-core';
...
export class EnhancedLogger {
    ...
    createChild(childName, configOverride) {
        ...
        const childLogger = new EnhancedLogger(fullName, Object.assign(Object.assign({}, this.config), configOverride // Apply child-specific overrides
        ));
    ...
    logError(error, context) {
        ...
        this.log(LogLevel.ERROR, error.message, Object.assign(Object.assign({}, errorContext), { errorName: error.name, 
    ...
    log(level, message, context) {
        ...
        if (this.config.structured) {
            ...
            try {
                const logEntry = Object.assign(Object.assign({ timestamp, level: LogLevel[level], logger: this.name, message }, (context !== undefined && { context })), this.config.additionalMetadata);
